...
if __name__ == '__main__':
    ...
    # ef.data_controller.import_csv(f'C:\\Users\\sportbilly\\Downloads\\consumption.csv')
    # ef.data_controller.import_csv(f'C:\\Users\\sportbilly\\Downloads\\elecsales.csv')
